 ...
 * @ployComponentDescription Adaptive inner-page hero with dark and light editorial variants. The editorial case-study treatment places an optional wide landscape cover above the title, summary, and ruled project metadata.
    ...
    <section className={`cs-hero relative overflow-hidden bg-ploy-background-primary px-5 pb-16 pt-28 sm:px-8 sm:pb-20 sm:pt-32 lg:px-10 ${editorial ? "" : "flex min-h-screen items-end"}`}>
      {backgroundImage && editorial && (
        <motion.div
          ...
          className="cs-hero__cover mx-auto aspect-[16/7] w-full max-w-[92rem] overflow-hidden rounded-xl bg-ploy-background-secondary"
        >
      ...
      <div className={`cs-hero__inner relative mx-auto w-full max-w-[92rem] ${editorial && backgroundImage ? "mt-14 sm:mt-20" : ""}`}>
