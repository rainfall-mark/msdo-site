  ...
  return (
    <section id={id} className="about-profile scroll-mt-20 bg-ploy-background-primary px-5 pb-24 pt-24 sm:px-8 sm:pb-32 sm:pt-32 lg:px-10 lg:pb-40 lg:pt-40">
      <div className="mx-auto max-w-[92rem]">
        {heading && <Reveal className="mb-12 sm:mb-16"><p className="mb-3 text-sm text-ploy-text-secondary">Studio / 03</p><h2 className="font-heading text-4xl font-semibold tracking-[-0.045em] text-ploy-text-primary sm:text-6xl">{heading}</h2></Reveal>}
