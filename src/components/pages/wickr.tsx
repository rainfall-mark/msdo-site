...
/**
 * @ployComponent
 * @ployComponentId wickr-case-study-page
 * @ployComponentType page
 * @ployComponentPattern case-study
 * @ployComponentDescription Wickr concepts portfolio case study using the shared editorial project template.
 * @ployComponentTags case-study wickr mobile social privacy
