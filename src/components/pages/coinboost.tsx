...
/**
 * @ployComponent
 * @ployComponentId coinboost-case-study-page
 * @ployComponentType page
 * @ployComponentPattern case-study
 * @ployComponentDescription Coinboost portfolio case study using the shared editorial project template.
 * @ployComponentTags case-study coinboost mobile crypto
